...
class Step2: UIViewController, AVPlayerViewControllerDelegate {
    let player = AVPlayer(url:  Bundle.main.url(forResource: "Step-2-back", withExtension: "mp4")!)
    ...
    func playVideoInView() {
        guard let path = Bundle.main.url(forResource: "Step-2-back", withExtension: "mp4") else {
            return
        }
        print("self: ",self)
