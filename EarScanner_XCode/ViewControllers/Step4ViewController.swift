...
class Step4: UIViewController, AVPlayerViewControllerDelegate {
    let player = AVPlayer(url:  Bundle.main.url(forResource: "Step-4-close", withExtension: "mp4")!)
    ...
    func playVideoInView() {
        guard let path = Bundle.main.url(forResource: "Step-4-close", withExtension: "mp4") else {
            return
        }
        print("self: ",self)
